...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3539433281ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=chat&table=messages">`chat`.`messages`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tranzistoriada&table=inductors">`tranzistoriada`.`inductors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tranzistoriada&table=diodes">`tranzistoriada`.`diodes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tranzistoriada&table=resistors">`tranzistoriada`.`resistors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tranzistoriada&table=capacitors">`tranzistoriada`.`capacitors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tranzistoriada&table=cart_item">`tranzistoriada`.`cart_item`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tranzistoriada&table=users">`tranzistoriada`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=chat&table=Messages">`chat`.`Messages`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="4d27786d3c4d30693a2524267b78777e">
